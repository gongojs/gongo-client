  ...
  describe('CRUD', () => {
    ...
    describe('insert', () => {
      ...
      it('adds an id if none given (non-local collection)', () => {
        let col = new Collection(FakeDb, 'test', { idType: 'random' });
        col._insert = jest.fn();
        col._didUpdate = () => {};
      ...
      it('adds an id if none given (local collection)', () => {
        let col = new Collection(FakeDb, 'test', { isLocalCollection: true, idType: 'random' });
        col._insert = jest.fn();
        col._didUpdate = () => {};
      ...
      it('adds objectid', () => {
        ...
        col.insert({});
        const doc = col._insert.mock.calls[0][0];
